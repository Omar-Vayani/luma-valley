...
- [ ] A **notable events** feed: only events that changed something socially
      (theft, betrayal, birth, death, partnership, separation, job taken,
      shortage, retaliation), not routine eating and walking
- [ ] Every notable event records **who, what, where, and the cause** — the
      reason the actor chose it, captured at decision time
- [ ] Events are ranked by significance so a quiet moment shows the best story
- [ ] Per-creature **life story**: the handful of events that shaped this
      individual, readable in the inspector
- [ ] "While you were away": a short summary of what changed since the player
      last looked
- [ ] Nothing fabricated — every line traces to real simulation state
- [ ] Feed is bounded (cheap to keep, cheap to save)
